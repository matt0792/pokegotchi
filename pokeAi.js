...
function downloadHelper() {
  ...
  let userCoins = JSON.parse(sessionStorage.getItem("userCoins")) || 0;
  saveToFile(userPokemon, userCoins, id);
}
...
function readFile(event) {
  ...
  reader.onload = function (e) {
    ...
    try {
      ...
      sessionStorage.setItem("userPokemon", JSON.stringify(pPokemon));
    } catch (err) {
